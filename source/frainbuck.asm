...
; TODO: Add a check for a stdin_pointer overflow and null terminator
...
stdin_buffer_size equ 1024                  ; The size of the brainfuck stdin input buffer
...
; ----------------------------------------------------------------------------------------------------------------------
read_input_in_cell:
    mov r11, [stdin_pointer]                ; Store the value of the input offset which is a character address
...
jump_backward_unnest:
    cmp dword [bracket_counter], 0          ; Check if the bracket counter is 0
    je jump_backward_end                    ; If so, go back 1 character and continue parsing the remaining characters
    dec dword [bracket_counter]             ; Decrement the bracket counter
    jmp jump_backward_loop                  ; Continue looping
